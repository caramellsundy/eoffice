...
$result = mysqli_query($conn, "SELECT * FROM surat_keluar WHERE id_keluar=$id");
...
<input type="date" name="tanggal" class="form-control" value="<?= $data['tanggal_keluar'] ?>" required>
</div>
<div class="mb-3">
<label>Tujuan</label>
